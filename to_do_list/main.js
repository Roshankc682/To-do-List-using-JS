...
//====Get the name===//
//===================//
var myFunction_to_get_name_from_page = document.querySelector("#myFunction_to_get_name");

myFunction_to_get_name_from_page.addEventListener("click", myFunction_to_get_name , false);
...
if (name_from_user_from_storage === null ) {
	...
	document.getElementById("Name_of_user").innerHTML += '<h1 class="name_header_tag" style="color: white;">You can do it '+ name_from_user_from_storage_for_temp +'</h1>';
}
else 
{
	var name_from_user_from_storage = localStorage.getItem('User');
	...
	// This will add the li value to html DOM :)
	document.getElementById("Name_of_user").innerHTML += '<h1 style="color: white;">You can do it '+ name_from_user_from_storage+'</h1>';
}
...
document.addEventListener('DOMContentLoaded', function() {
  document.getElementById("myFunction").addEventListener("click", myFunction_custom_by_user);
});
...
function saveState() {
	localStorage.setItem('DO_TASK', document.getElementById("list-group").innerHTML);
}
...
if (savedToDoList === null) {
	document.getElementById("list-group").innerHTML = `<li style="color:white;list-style-type: none;border-radius: 25px;width: 750px;cursor: pointer;position: relative;padding: 14px 12px 14px 50px;margin: 0px 15px 10px 0px;background: rgba(102, 26, 97, 0.8);font-size: 15px;transition: 0.2s;-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;" class="items_to_do_list" id="Done_task">Try harder :) &nbsp;&nbsp;&nbsp;&nbsp;<span class="material-icons" style="position: absolute;right: 0;top: 0;padding: 15px 20px;">Delete</span></li>
	...
	document.getElementById("list-group").innerHTML = localStorage.getItem('DO_TASK');
}
...
function myFunction_image() {
  var url_store = document.getElementById('image_url').value;
          if (url_store === "") {
                      ...
                      var url_parameter = document.body.style.backgroundImage = "url('"+ url_store +"')";
...
//======Motivational Quote===========//
//==================================*//
var cars = ["Make sure you're dedicating your time to something worthwhile.", "Accomplish something today and be proud of it.", "You have total control.","The road to success is probably paved with facepalms.","Put forth your best effort as much as possible.","Work with a purpose: to be successful.","Don't listen to the haters; they're usually your competition.","Keep it to yourself until it speaks for itself."];
...
function f_1()
{
	var image_by_developer_1 = document.getElementById("img_name_1").getAttribute('src');
...
function f_2()
{
	var image_by_developer_2 = document.getElementById("img_name_2").getAttribute('src');
...
function f_3()
{
	var image_by_developer_3 = document.getElementById("img_name_3").getAttribute('src');
...
function f_4()
{
	var image_by_developer_4 = document.getElementById("img_name_4").getAttribute('src');
...
function f_5()
{
	var image_by_developer_5 = document.getElementById("img_name_5").getAttribute('src');
	// alert(image_by_developer_4)
...
function f_6()
{
	var image_by_developer_6 = document.getElementById("img_name_6").getAttribute('src');
	// alert(image_by_developer_4)
...
function f_7()
{
	var image_by_developer_7 = document.getElementById("img_name_7").getAttribute('src');
	// alert(image_by_developer_4)
...
function f_8()
{
	var image_by_developer_8 = document.getElementById("img_name_8").getAttribute('src');
	// alert(image_by_developer_4)
...
function f_9()
{
	var image_by_developer_9 = document.getElementById("img_name_9").getAttribute('src');
	// alert(image_by_developer_4)
